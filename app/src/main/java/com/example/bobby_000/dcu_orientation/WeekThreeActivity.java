...
public class WeekThreeActivity extends AppCompatActivity {
    ...
    void print()
    {
        ...
        focusthisweeklist = (ListView)findViewById(R.id.list3_1);
        ArrayAdapter focus_this_week_adapter = new ArrayAdapter<>(this,R.layout.focusthisweekfont,value.getFocus_this_week(".*\\borientationWeek3\\b.*"));
        focusthisweeklist.setAdapter(focus_this_week_adapter);
        LinksPattern linksPattern = new LinksPattern(this);
        linearLayout = (LinearLayout) findViewById(R.id.wk_steps_wk3);
        linearLayout.setOrientation(LinearLayout.VERTICAL);
        ArrayList<String> weeksteps = value.getWeek_steps();
        //todo fix void method to print out textview
