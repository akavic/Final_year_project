...
public class WeekFourActivity extends AppCompatActivity {
    ...
    void print() {
        ...
        focusthisweeklist = (ListView) findViewById(R.id.list4_1);
        ArrayAdapter focus_this_week_adapter = new ArrayAdapter<>(this, R.layout.focusthisweekfont, value.getFocus_this_week(".*\\borientationWeek4\\b.*"));
        focusthisweeklist.setAdapter(focus_this_week_adapter);
        LinksPattern linksPattern = new LinksPattern(this);
        linearLayout = (LinearLayout) findViewById(R.id.wk_steps_wk4);
